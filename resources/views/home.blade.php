...
@section('content')
<div id="mainblock" class="container-fluid border rounded-3">
...
<div id="projects" class="container-fluid">
  <div class="row">
        <div class="projectdescr col-sm-7">
        ...
        <div class="descrimg col-sm-5">
          <img src="/img/paginators.png" />
        </div>
  </div>
  <div class="row">
      ...
      <div class="projectdescr col-md-7">
  ...
  <p class="lead">A Laravel library with jQuery add-on to add tags (Boostrap badges) selected by an auto-completer.</p>
